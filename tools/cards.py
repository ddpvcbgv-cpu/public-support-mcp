...
CARD_LIBRARY: Dict[str, List[Dict[str, str]]] = {
    ...
    "법률·권리 상담": [
        ...
        {
            "card": "임대차·주거 분쟁 상담 정보",
            "이게_뭐냐면": "전·월세 계약, 보증금, 퇴거 통보 등 주거 관련 문제를 상담해주는 공공 지원 정보예요",
            "왜_지금_맞냐면": "집 문제는 생활 전반과 바로 연결돼서 혼자 판단하면 손해로 이어지는 경우가 많아서요",
            "지금_하실_수_있는_말": "전세·월세 문제로 상담받을 수 있는 곳이 있는지 알고 싶어요",
            "where": "주거복지센터 / 법률구조공단 / 지자체 주거상담 창구",
            "막히면": "계약서가 없어도 '임대차 문제 상담만 먼저 받고 싶어요'라고 말해도 괜찮아요"
        },
    ],
    "교통·이동 지원": [
        {
