...
EXTENDED_DOMAINS = ["문화·여가", "평생교육", "참여·활동", "법률·권리 상담", "교통·이동 지원", "디지털·정보 접근"]
...
DOMAIN_HINTS: Dict[str, List[str]] = {
    ...
    "법률·권리 상담": ["법률", "권리", "상담", "법원", "소송", "계약", "분쟁", "임대차"],
    "교통·이동 지원": ["교통", "이동", "대중교통", "교통비", "버스", "지하철", "택시", "기후동행카드"],
    "디지털·정보 접근": ["디지털", "정보", "통신", "인터넷", "휴대폰", "온라인", "디지털 격차", "통신비"],
}
